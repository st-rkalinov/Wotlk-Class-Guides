var whTooltips = {colorLinks: true, iconizeLinks: true, renameLinks: true, iconSize: 'small'};
...
if (typeof $WowheadPower === "undefined") {
    var $WowheadPower = new function() {
        ...
        var av = {
            ...
            ag, z, P, at, l, am, aq, ap, al = aA["float"],
            B = false,
            aa = null,
            A = 1,
            y = 1,
        ...
        function aG(aT) {
            ...
            return {
                min: Y[aT].hasOwnProperty("minId") ? Y[aT].minId : 1,
                max: Y[aT].maxId
            }
        }
        ...
        function ay(aU, aV, aT) {
            ...
            if (aT === "tiny") {
                ...
                WH.aef(aU, WH.Icon.create(aW, aT, null, {
                    span: true
                }))
            }
        ...
        function aw(a3, aU, aV, a6, a2, aW) {
            ...
            if (a0 && (parseInt(aU, 10) < a0.min || parseInt(aU, 10) > a0.max)) {
                $WowheadPower.register(a3, aU, aV, a6, {
                ...
                if (l != null) {
                    if (WH.reforgeStats && l.forg && WH.reforgeStats[l.forg]) {
                        ...
                        if ((bp = be.match(new RegExp("(<!--(stat|rtg)(" + bu.join("|") + ")-->)[+-]?([0-9]+)"))) && !be.match(new RegExp("<!--(stat|rtg)" + aZ.i2 + "-->[+-]?[0-9]+"))) {
                            var bm = Math.floor(bp[4] * aZ.v),
                                bk = aK.traits[aZ.s2][0];
                            if (aZ.i2 == 6) {
        ...
        function F(aU, aW, aV) {
            ...
            if (aT && aT.screenshot) {
                return [WH.getScreenshotUrl(aT.screenshot.id, "small", {
                    imageType: aT.screenshot.imageType
                }), "screenshot"]
            }
            return false
        }
